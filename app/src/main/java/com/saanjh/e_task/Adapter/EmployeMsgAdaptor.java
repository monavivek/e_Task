...
public class EmployeMsgAdaptor extends ArrayAdapter<BeanParameter> {
    ...
    public EmployeMsgAdaptor(Context context, int resource, List<BeanParameter> objects) {
                ...
                try {
                    ...
                    for (int i = 0; i < positionArray.size(); i++) {
                        ...
                        if (positionArray.get(i) == true) {
                            ...
                            SendMsgFragment.token_id = token;
                            SendMsgFragment.EMP_SRNO = sr_no;
                            SendMsgFragment.EMP_LIST.setText(result);
                        }

...
public class EmployeAdaptor extends ArrayAdapter<BeanParameter> {

    private BeanParameter dev1 = null;
    private ArrayList<Boolean> positionArray;
    private String result = "", token = "", sr_no = "";
    private Context context;
    private List<BeanParameter> employee = new ArrayList<BeanParameter>();

    public EmployeAdaptor(Context context, int resource, List<BeanParameter> objects) {
                ...
                try {
                    ...
                    for (int i = 0; i < positionArray.size(); i++) {
                        ...
                        if (positionArray.get(i) == true) {
                            ...
                            AssignTaskFragment.SR_NO = sr_no;
                            AssignTaskFragment.SELECT_EMPLOYEE.setText(result);
                        }
